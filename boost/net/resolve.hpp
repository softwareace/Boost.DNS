  ...
  namespace net
  {
    namespace dns
    {
      ...
      public:
        ...
        resolve () :
          ioservice(), socket(ioservice, ip::udp::endpoint(ip::udp::v4(), 0)), retry_timer(ioservice), death_timer(
              ioservice), death_timeout(30), endpointList(), responseMessage(), reqBuffer(), requestCount(),
              bufferMutex()
        {
        }
