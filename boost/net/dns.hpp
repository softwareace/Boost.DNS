  ...
  namespace net
  {
    namespace dns
    {
      ...
      protected:
         ...
         */
        void
        encode ( dns_buffer_t& buffer, rfc1035_414_t& offset_map )
        {
         ...
         */
        void
        decode ( dns_buffer_t& buffer, rfc1035_414_t& offset_map )
        {
      ...
      public:
         ...
         */
        virtual shared_resource_base_t
        clone () const
        {
      ...
      protected:
         ...
         */
        virtual void
        decode ( dns_buffer_t& buffer, rfc1035_414_t& )
        {
      ...
      public:
        /// Default contructor
        a_resource () :
          resource_base_t(type_a), rr_address(0)
        {
          ;
        }
         ...
         */
        ip::address_v4&
        address ( const ip::address_v4& addr )
        {
          rr_address = addr;
          return rr_address;
        }
      ...
      protected:
         ...
         */
        a_resource ( const a_resource& o ) :
          resource_base_t(o), rr_address(o.rr_address)
        {
          ;
        }
        ...
        /*!
         ...
         \param o resource_base_t to copy from
         */
        a_resource ( const resource_base_t& o ) :
          resource_base_t(o), rr_address(0)
        {
          ;
        }
      ...
      public:
        /// Default contructor
        ns_resource () :
          resource_base_t(type_ns), rr_nsdname()
        {
          ;
        }
         ...
         */
        ns_resource ( const string& s ) :
          resource_base_t(s, type_ns), rr_nsdname(s)
        {
          ;
        }
      ...
      protected:
         ...
         */
        ns_resource ( const ns_resource& o ) :
          resource_base_t(o), rr_nsdname(o.rr_nsdname)
        {
          ;
        }
      ...
      public:
        /// Default contructor
        cname_resource () :
          resource_base_t(type_cname), rr_cname()
        {
          ;
        }
         ...
         */
        cname_resource ( const string& s ) :
          resource_base_t(s, type_cname), rr_cname(s)
        {
          ;
        }
      ...
      protected:
         ...
         */
        cname_resource ( const cname_resource& o ) :
          resource_base_t(o), rr_cname(o.rr_cname)
        {
          ;
        }
        ...
        /*!
         ...
         \param o resource_base_t to copy from
         */
        cname_resource ( const resource_base_t& o ) :
          resource_base_t(o), rr_cname()
        {
          ;
        }
      ...
      public:
        /// Default contructor
        soa_resource () :
          resource_base_t(type_soa), rr_mname(), rr_rname(), rr_serial(0), rr_refresh(0), rr_retry(0), rr_expire(0),
              rr_minttl(0)
        {
          ;
        }
        ...
        soa_resource ( const string& s ) :
          resource_base_t(s, type_soa), rr_mname(), rr_rname(), rr_serial(0), rr_refresh(0), rr_retry(0), rr_expire(0),
              rr_minttl(0)
        {
          ;
        }
         ...
         */
        const string&
        responsible_name ( const string& s )
        {
         ...
         */
        uint32_t
        serial_number ( const uint32_t d )
        {
          rr_serial = d;
          return rr_serial;
        }
      ...
      protected:
        ...
        soa_resource ( const soa_resource& o ) :
          resource_base_t(o), rr_mname(o.rr_mname), rr_rname(o.rr_rname), rr_serial(o.rr_serial), rr_refresh(
              o.rr_refresh), rr_retry(o.rr_retry), rr_expire(o.rr_expire), rr_minttl(o.rr_minttl)
        {
        }
        ...
        soa_resource ( const resource_base_t& o ) :
          resource_base_t(o), rr_mname(), rr_rname(), rr_serial(0), rr_refresh(0), rr_retry(0), rr_expire(0),
              rr_minttl(0)
        {
          ;
        }
      ...
      public:
        /// Default contructor
        ptr_resource () :
          resource_base_t(type_ptr), rr_ptrdname()
        {
          ;
        }
         ...
         */
        ptr_resource ( const string& s ) :
          resource_base_t(s, type_ptr), rr_ptrdname(s)
        {
          ;
        }
      ...
      protected:
         ...
         */
        ptr_resource ( const ptr_resource& o ) :
          resource_base_t(o), rr_ptrdname(o.rr_ptrdname)
        {
          ;
        }
        ...
        /*
         \param o resource_base_t to copy from
         */
        ptr_resource ( const resource_base_t& o ) :
          resource_base_t(o), rr_ptrdname()
        {
          ;
        }
      ...
      public:
        /// Default contructor
        hinfo_resource () :
          resource_base_t(type_hinfo), rr_cpu(), rr_os()
        {
          ;
        }
        ...
        /*
         \param s Host name for the PTR record
         */
        hinfo_resource ( const string& s ) :
          resource_base_t(s, type_hinfo), rr_cpu(), rr_os()
        {
          ;
        }
      ...
      protected:
         ...
         */
        hinfo_resource ( const hinfo_resource& o ) :
          resource_base_t(o), rr_cpu(o.rr_cpu), rr_os(o.rr_os)
        {
          ;
        }
        ...
        /*
         \param o resource_base_t to copy from
         */
        hinfo_resource ( const resource_base_t& o ) :
          resource_base_t(o), rr_cpu(), rr_os()
        {
          ;
        }
      ...
      public:
        /// Default contructor
        mx_resource () :
          resource_base_t(type_mx), rr_preference(0), rr_exchange()
        {
        }
         ...
         */
        mx_resource ( const string& s ) :
          resource_base_t(s, type_mx), rr_preference(0), rr_exchange()
        {
        }
         ...
         */
        const uint16_t
        preference ( const uint16_t d = 0xffff )
        {
          if( d != 0xffff )
            rr_preference = d;
      ...
      protected:
        ...
        mx_resource ( const mx_resource& o ) :
          resource_base_t(o), rr_preference(o.rr_preference), rr_exchange(o.rr_exchange)
        {
          ;
        }
        ...
        mx_resource ( const resource_base_t& o ) :
          resource_base_t(o), rr_preference(0), rr_exchange()
        {
        }
      ...
      public:
        /// Default contructor
        txt_resource () :
          resource_base_t(type_txt), rr_text()
        {
          ;
        }
         ...
         */
        txt_resource ( const string& s ) :
          resource_base_t(s, type_txt), rr_text(s)
        {
          ;
        }
      ...
      protected:
         ...
         */
        txt_resource ( const txt_resource& o ) :
          resource_base_t(o), rr_text(o.rr_text)
        {
          ;
        }
        ...
        /*
         \param o resource_base_t to copy from
         */
        txt_resource ( const resource_base_t& o ) :
          resource_base_t(o), rr_text()
        {
          ;
        }
      ...
      public:
        /// Default contructor
        a6_resource () :
          resource_base_t(type_a6), rr_address()
        {
          ;
        }
        ...
        /*
         \param s Host name for the A record
         */
        a6_resource ( const string& s ) :
          resource_base_t(s, type_a6), rr_address()
        {
          ;
        }
         ...
         */
        const ip::address_v6&
        address ( const ip::address_v6& addr )
        {
          rr_address = addr;
          return rr_address;
        }
         ...
         */
        const ip::address_v6&
        address ( const char* s = 0 )
        {
          if( s != 0 )
            return address(ip::address_v6::from_string(s));
          return rr_address;
        }
      ...
      protected:
         ...
         */
        a6_resource ( const a6_resource& o ) :
          resource_base_t(o), rr_address(o.rr_address)
        {
          ;
        }
        ...
        /*
         \param o resource_base_t to copy from
         */
        a6_resource ( const resource_base_t& o ) :
          resource_base_t(o), rr_address()
        {
          ;
        }
      ...
      public:
        /// Default contructor
        srv_resource () :
          resource_base_t(type_srv), rr_priority(0), rr_weight(0), rr_port(0), rr_target()
        {
          ;
        }
        ...
        srv_resource ( const string& s ) :
          resource_base_t(s, type_srv), rr_priority(0), rr_weight(0), rr_port(0), rr_target(s)
        {
          ;
        }
         ...
         */
        uint16_t
        priority ( const uint16_t d = 0xffff )
        {
          if( d != 0xffff )
            rr_priority = d;
          return rr_priority;
         ...
         */
        uint16_t
        weight ( const uint16_t d = 0xffff )
        {
          if( d != 0xffff )
            rr_weight = d;
          return rr_weight;
      ...
      protected:
        ...
        srv_resource ( const srv_resource& o ) :
          resource_base_t(o), rr_priority(o.rr_priority), rr_weight(o.rr_weight), rr_port(o.rr_port), rr_target(
              o.rr_target)
        {
          ;
        }
        ...
        srv_resource ( const resource_base_t& o ) :
          resource_base_t(o), rr_priority(0), rr_weight(0), rr_port(0), rr_target()
        {
          ;
        }
      ...
      public:
         ...
         */
        action_t
        action ( const action_t e )
        {
          ( e == query ) ? header.bit_fields &= static_cast< uint16_t > (~0x8000) : header.bit_fields
         ...
         */
        void
        authority ( const bool authority )
        {
          ( authority ) ? header.bit_fields |= static_cast< uint16_t > (0x0400) : header.bit_fields
         ...
         */
        void
        truncated ( const bool truncated )
        {
          ( truncated ) ? header.bit_fields |= static_cast< uint16_t > (0x0200) : header.bit_fields
              &= static_cast< uint16_t > (~0x0200);
        }
        ...
        is_truncated () const
        {
          return ( header.bit_fields & 0x200 );
        }
         ...
         */
        void
        recursive ( const bool recursive )
        {
          ( recursive ) ? header.bit_fields |= static_cast< uint16_t > (0x0100) : header.bit_fields
        ...
        is_recursive () const
        {
          return ( header.bit_fields & 0x100 );
        }
         ...
         */
        void
        recursion_avail ( const bool recursion_avail )
        {
          ( recursion_avail ) ? header.bit_fields |= static_cast< uint16_t > (0x0080) : header.bit_fields
      ...
      private:
        shared_resource_base_t
        unpack_record ( dns_buffer_t& buffer, rfc1035_414_t& offset_map )
        {
